...
google-chrome --user-data-dir="$folder_path" --load-extension="$(pwd)/Propeller-main","$(pwd)/Enable-Copy-Paste-neocolab-main/Package","$(pwd)/DontF-WithPaste-master","$(pwd)/always-active-master/v3"
